...
public class DoneTasksAdapter extends TaskAdapter {
    ...
    public DoneTasksAdapter(TaskFragment taskFragment) {
        super(taskFragment);
    }
        ...
        if (item.isTask()) {
            ...
            taskViewHolder.category.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    getTaskFragment().activity.dbHelper.update().status(task.getTimeStamp(), ModelTask.STATUS_CURRENT, 0);

                    getTaskFragment().activity.dbHelper.update().timeStart(task.getTimeStamp(), task.getTimeStart());
