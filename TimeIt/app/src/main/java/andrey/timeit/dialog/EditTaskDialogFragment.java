 ...
 */
    public class EditTaskDialogFragment extends DialogFragment {
        ...
        public static EditTaskDialogFragment newInstance(ModelTask task) {
            ...
            args.putInt("priority", task.getCategory());
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final ModelTask task = new ModelTask(title, date, category, 0, timeStamp, calendar.getTimeInMillis(), 0);
            ...
            Spinner spCategory = (Spinner) container.findViewById(R.id.spDialogTaskCategory);
            ...
            spCategory.setSelection(task.getCategory());
